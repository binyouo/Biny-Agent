/** 消息菜单中的工具/技能清单；浮层脱离菜单动画，指针穿越间隙时保留短暂关闭宽限。 */
...
export function MessageContextMenu({ tools, skills, descriptions }: { tools: readonly string[]; skills: readonly string[]; descriptions?: ReadonlyMap<string, string> }): React.JSX.Element {
